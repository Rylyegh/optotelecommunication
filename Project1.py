...
Bsystem = Bsig*1.1
print("Bandwidth system = ",Bsystem)
Btx = Bsystem*1.9
print("Bandwidth transmitter and receiver = ",Btx)
...
D_min = (dispersion_slope/4)*(min_op_wavelength-(center_frequency**4/min_op_wavelength**3))+(dispersion_slope/2)*RMS
D_max = (dispersion_slope/4)*(max_op_wavelength-(center_frequency**4/max_op_wavelength**3))+(dispersion_slope/2)*RMS

L_bandwidth_min = (delta_tf/10**-12)/(abs(D_min)*RMS)
L_bandwidth_max = (delta_tf/10**-12)/(abs(D_max)*RMS)

print("Minimum Bandwidth length: ",L_bandwidth_min)
print("Maximum Bandwidth length: ",L_bandwidth_max)
...
print("Minimum Power length: ",L_power_min)
print("Maximum Power length: ",L_power_max)